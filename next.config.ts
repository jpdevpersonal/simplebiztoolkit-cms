...
const ContentSecurityPolicy = `
  ...
  img-src 'self' data: https://www.simplebiztoolkit.com https://*.blob.core.windows.net blob: https://www.google-analytics.com https://*.google-analytics.com https://www.google.com https://www.google.co.uk https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net;
  font-src 'self';
  connect-src 'self' ${isProd ? "https://www.simplebiztoolkit.com" : "http://localhost:5117"} https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://*.analytics.google.com https://stats.g.doubleclick.net https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net;
